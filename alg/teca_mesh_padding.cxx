    ...
    const teca_metadata &request)
{
    ...
    if (py_low || py_high || px_low || px_high)
    {
        ...
        req_whole_extent[1] = nx_new;
        req_whole_extent[3] = ny_new;
        ...
        TEMPLATE_DISPATCH_FP(
            ...
            teca_algorithm_util::expand_dimension(p_y_crds_new, p_y_crds, n_y,
                            py_low, py_high);
        ...
        TEMPLATE_DISPATCH_FP(
            ...
            teca_algorithm_util::expand_dimension(p_x_crds_new, p_x_crds, n_x,
                            px_low, px_high);
        ...
        for (size_t i = 0; i < n_arrays; ++i)
        {
            ...
            TEMPLATE_DISPATCH_FP(
                ...
                out_mesh->get_point_arrays()->set(i, padded_array);
            )
        }
